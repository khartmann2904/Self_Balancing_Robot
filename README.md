...
> 🚧 **Status: ongoing project.** This robot is actively being developed and tuned — expect frequent changes to the firmware, control loop, and hardware as things get refined.
